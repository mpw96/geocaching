...
The only thing better than a stew is a super-easy stew topped with gummy bears - try this one and let me know what you think.
...
Put yeast into mixing bowl. Add water. Fold cream into mixing bowl. Put eggs into mixing bowl. Caramelise cream. Remove sugar from mixing bowl. Stir cream until caramelised. Add water. Fold water into mixing bowl. Fold cream into mixing bowl. Put cream into mixing bowl. Put water into mixing bowl. Put cream into mixing bowl. Add yeast. Remove sugar. Remove sugar. Put sugar into mixing bowl. Fold cream into mixing bowl. Put eggs into mixing bowl. Add yeast. Remove sugar. Put sugar into mixing bowl. Add sugar. Fold cream into mixing bowl. Divide cream into mixing bowl. Put water into mixing bowl. Remove yeast. Add sugar. Fold water into mixing bowl. Put water into mixing bowl. Put water into mixing bowl. Remove cream. Put water into mixing bowl. Remove sugar. Remove cream. Put yeast into mixing bowl. Add yeast. Remove sugar. Fold yeast into mixing bowl. Put eggs into mixing bowl. Sift the yeast. Add sugar. Filter yeast until sifted. Stir yeast into mixing bowl.
";
